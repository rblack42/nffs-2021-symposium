...
this  here, more details are on the project website. You get to this interface by entering {\bf cmd} in the Windows search box, or my opening the {\it  Terminal} program}on  Mac systems. Linux users will open up a {\it shell} command window.We will only need to use this interface in the analysis of the design.
