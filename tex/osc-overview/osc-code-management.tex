...
Programmers like to group code related to one simple thing in a package \osc\
calls a {\it module}. I use modules to organize my design, creating them with
names like {\bf wing} or {\bf {rib} so it is obvious what they are all about.
If I create a {\bf rib} module in one file, and my {wing} module in another file,
I can {\it use} the rib module multiple times by adding this line at the top of the {\bf wing.scad} file:
...
\subsection{The Designing Process}
